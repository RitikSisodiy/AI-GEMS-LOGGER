...
from log_outgoing_requests.compat import parse_header_parameters
from log_outgoing_requests.conf import settings
from log_outgoing_requests.datastructures import ContentType, ProcessedBody
...
def _get_body(http_obj: HttpObj) -> Union[bytes, str, None]:
    content_res = ["content","body","_content"]
    for res in content_res:
        return getattr(http_obj,res)
